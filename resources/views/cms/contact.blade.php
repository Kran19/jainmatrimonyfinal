            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start gap-4 hover:shadow-md transition" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-primary">{{ $contact_phone }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start gap-4 hover:shadow-md transition" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-primary break-all">{{ $contact_email }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start gap-4 hover:shadow-md transition" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-gray-800">{{ $contact_address }}</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="John Doe" required class="w-full border-gray-300 border rounded-lg p-3 bg-gray-50 focus:border-primary focus:outline-none transition">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" placeholder="john@example.com" required class="w-full border-gray-300 border rounded-lg p-3 bg-gray-50 focus:border-primary focus:outline-none transition">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+91 90000 00000" class="w-full border-gray-300 border rounded-lg p-3 bg-gray-50 focus:border-primary focus:outline-none transition">
                            ...
                            <div>
                                ...
                                <select name="subject" required class="w-full border-gray-300 border rounded-lg p-3 bg-gray-50 focus:border-primary focus:outline-none transition">
                                    ...
                                    <option value="Profile Assistance" {{ old('subject') === 'Profile Assistance' ? 'selected' : '' }}>Profile Assistance</option>
                                    <option value="Membership Query" {{ old('subject') === 'Membership Query' ? 'selected' : '' }}>Membership Query</option>
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="5" placeholder="How can we help you today?" required class="w-full border-gray-300 border rounded-lg p-3 bg-gray-50 focus:border-primary focus:outline-none transition resize-none">{{ old('message') }}</textarea>
