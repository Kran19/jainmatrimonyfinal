...
class ProfileWizardController extends Controller
{
    ...
    public function savePersonal(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'occupation_details' => 'required_if:occupation,Other|nullable|string|max:255',
        ...
        $updateData = [
            ...
            'gotra' => ($request->gotra === 'Others' || $request->gotra === 'Other') ? $request->custom_gotra : $request->gotra,
            'mama_gotra' => ($request->mama_gotra === 'Others' || $request->mama_gotra === 'Other') ? $request->custom_mama_gotra : $request->mama_gotra,
            ...
            'income_type' => $request->income_type ?? 'Yearly',
